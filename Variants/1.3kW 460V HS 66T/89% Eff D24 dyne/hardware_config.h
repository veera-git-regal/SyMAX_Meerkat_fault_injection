...
#define HARDWARE_VERSION_1p3KW 1     // Rev C and B
#define HARDWARE_VERSION_4p5KW 2
#define HARDWARE_VERSION_8KW 3
#define HARDWARE_VERSION_1p3KW_REVE_AND_BELOW 4  // 1.3kW HW rev E and below
#define HARDWARE_VERSION_1p3KW_REVE_AND_BELOW_EXT_CRYSTAL 5 // 1.3kW HW rev E and below with an external crystal

#define HARDWARE_VERSION HARDWARE_VERSION_1p3KW //HARDWARE_VERSION_1p3KW // set this to choose the HW version
