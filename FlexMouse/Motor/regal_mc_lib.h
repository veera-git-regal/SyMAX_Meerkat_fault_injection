...
#define default_MAX_COMMANDABLE_SPEED   (uint16_t) (0.9 * MAX_APPLICATION_SPEED_RPM) /* maximum commandable speed is based on the maximum application speed*/
...
#define default_OCP_THRESHOLD           (uint16_t) (1 * NOMINAL_CURRENT) /* based on OCP settings */
#define default_OCP_LOWER_THRESHOLD     (uint16_t) (1 * NOMINAL_CURRENT) /* based on OCP settings */
...
#define default_OVP_LOWER_THRESHOLD     1550//(int16_t) (default_OVP_THRESHOLD * 0.9) 
...
#define default_OVP_LOWER_THRESHOLD     4600//(int16_t) (default_OVP_THRESHOLD * 0.9) 
...
#define default_OVP_LOWER_THRESHOLD     8000//(int16_t) (default_OVP_THRESHOLD * 0.9) 
#else
#define default_OVP_THRESHOLD          (int16_t)(0.98 * 1500) /* based on mechanical power and efficiency */
#define default_OVP_LOWER_THRESHOLD     1400//(int16_t) (default_OVP_THRESHOLD * 0.9) 
#endif
...
#define default_OTP_LOWER_THRESHOLD     (uint16_t) (default_OTP_THRESHOLD * 0.85)              //multiply by 90% of the over temperature threshold 
#define default_OTP_RPM_REDUCE          (uint8_t)(default_MAX_COMMANDABLE_SPEED/260) //  16 //
...
#define default_BK_LOWSIDE_DURATION    (uint16_t)(5000) //(5000 + (uint16_t)(628.32 * POLE_PAIR_NUM * TOTAL_INERTIA * default_BK_ENDSPEED / (TORQUE_CONSTANT * PHASE4_FINAL_CURRENT - default_MOTOR_VISCOUS_DAMPING)))
...
#define COUNTS_TO_MA_CONVERSION        (uint32_t) ( (float) ADC_REFERENCE_VOLTAGE * 1000 /((float)AMPLIFICATION_GAIN * (float)RSHUNT))
#define MA_TO_COUNTS_PRECISION         16
#define COUNTS_TO_MA_PRECISION         16 /* For GMI, value is 10-bit integer and 6-bit fraction to accommodate 230V drive settings  */
...
void updateAvrPhCurrent(FOCVars_t * pFOCHandle_t);
...
extern int32_t avrCurrentRdOP; //This will be used for current derating filtering
