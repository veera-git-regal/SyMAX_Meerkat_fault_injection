...
#define VBUS_PARTITIONING_FACTOR      0.0067 /*!< It expresses how 
                                                       much the Vbus is attenuated  
                                                       before being converted into 
                                                       digital value */
#define NOMINAL_BUS_VOLTAGE_V         205 
...
#define AMPLIFICATION_GAIN            14.73 
...
#define V0_V                          0.292 /*!< in Volts */
#define T0_C                          0 /*!< in Celsius degrees */
#define dV_dT                         0.0154 /*!< V/Celsius degrees */
