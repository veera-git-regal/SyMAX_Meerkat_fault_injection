...
#define RS                     0.03 /* Stator resistance , ohm*/
#define LS                     0.000777 /* Stator inductance, H
...
#define NOMINAL_CURRENT         17018
#define MOTOR_MAX_SPEED_RPM     4670 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  41.2 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -17018 /*!< Demagnetization current */
