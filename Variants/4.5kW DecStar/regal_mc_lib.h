...
#define default_MOTOR_INERTIA           5.0 /* just for test on the blender */
#define default_MOTOR_VISCOUS_DAMPING   1.0      /* RPa: coefficient of dynamic friction */
...
#define NOMINAL_DC_VOLTAGE              100 /*230V variant: 375, 460V variant: 650 */
//////////////////////////////////////////////////////////
...
#define default_OVP_THRESHOLD           (int16_t) (0.8 * 4500)  /* based on mechanical power and efficiency */
...
#define default_POWERUP_DURATION     (uint32_t) (5000 + (uint32_t)(104.72 * POLE_PAIR_NUM * TOTAL_INERTIA *  (default_MAX_COMMANDABLE_SPEED - (2*OBS_MINIMUM_SPEED_RPM))/ (TORQUE_CONSTANT * NOMINAL_CURRENT - default_MOTOR_VISCOUS_DAMPING)))/* RPa: t (sec) = J*poles*w/(Kt*I);5000;628.3185=1000*2*pi*6/60 */
/////////////////////////////////////////////////////////
