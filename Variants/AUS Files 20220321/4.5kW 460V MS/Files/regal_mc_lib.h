...
#define NOMINAL_DC_VOLTAGE              650 /*230V variant: 375, 460V variant: 650; nominal dc voltage as seen on the bus */
//////////////////////////////////////////////////////////
...
#define default_BK_VBUS_CLIP             (uint16_t) (0.50 * ( OV_VOLTAGE_THRESHOLD_V - NOMINAL_DC_VOLTAGE))   /* based on the difference between voltage levels and OVP setting */
#define default_BK_ENDSPEED             15 //(uint16_t) (1110 / MOTOR_VOLTAGE_CONSTANT)   /* RPa: Ke, SNR, and voltage levels, arbitrary: 10V bemf level, but this needs to consider OCP */
...
#define default_WM_MAX_REVERSE_SPEED            70//(uint16_t) (OBS_MINIMUM_SPEED_RPM / 5 ) /* above the observer min speed, raise a startup failure */
...
#define STOP_WAIT_TIME                  3000      // Reduce this value when testing OTF
