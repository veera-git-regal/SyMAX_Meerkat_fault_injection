...
/**
  * @brief  Generate DC break signal
  * @param  pHandle: handler of the current instance of the PWM component
  * @retval none
  */
__weak void DC_BreakSignal_PAM( PWMC_Handle_t * pHdl )
{
#if defined (__ICCARM__)
  #pragma cstat_disable = "MISRAC2012-Rule-11.3"
#endif /* __ICCARM__ */
  ...
  /*Turn on the three low side switches */
  LL_TIM_OC_SetCompareCH1( TIMx, ((uint32_t) pHandle->Half_PWMPeriod / (uint32_t) 32) );
  LL_TIM_OC_SetCompareCH2( TIMx, ((uint32_t) pHandle->Half_PWMPeriod / (uint32_t) 32));
  LL_TIM_OC_SetCompareCH3( TIMx, ((uint32_t) pHandle->Half_PWMPeriod / (uint32_t) 32) );
