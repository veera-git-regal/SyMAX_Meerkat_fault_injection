...
#define default_BK_ENDSPEED             40 //(uint16_t) (1110 / MOTOR_VOLTAGE_CONSTANT)   /* RPa: Ke, SNR, and voltage levels, arbitrary: 10V bemf level, but this needs to consider OCP */
...
#define default_OTF_MIN_SYNC_SPEED      (uint16_t) (OBS_MINIMUM_SPEED_RPM / 8 ) /* RPa: Note that value is used as RPM/6 */
...
#define default_WM_MAX_REVERSE_SPEED            40//(uint16_t) (OBS_MINIMUM_SPEED_RPM / 5 ) /* above the observer min speed, raise a startup failure */
