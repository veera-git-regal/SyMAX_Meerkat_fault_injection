...
/* MMI Table Motor 1 MAX_MODULATION_83_PER_CENT */
#define START_INDEX 44
#define MAX_MODULE 27196
#define MMITABLE  {32291,32060,31613,31397,30977,30573,30377,29996,29811,29451,29276,28934,28768,\
