...
#define FAN_INERTIA                     50 /*RPa: g*m^2 */
...
#define default_OTF_DBEMFG              100 /* RPa: Ke (based on observer design  and voltage level under operation; please refer to On-the-fly document for more information */
