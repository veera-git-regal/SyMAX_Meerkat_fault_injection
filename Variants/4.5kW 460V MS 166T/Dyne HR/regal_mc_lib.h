...
#define PID_BRAKE_KP_DEFAULT            25 //45//545   // Proportional Gain for Bus Voltage Controller
...
#define BK_KPDIV                        32 //16        //Proportional Gain divider for Bus Voltage Controller
...
#define BK_KPDIV_LOG                    LOG2(32) //16)  //Proportional Gain divider (in linear scale) for Bus Voltage Controller
...
#define NOMINAL_DC_VOLTAGE              NOMINAL_BUS_VOLTAGE_V /*230V variant: 375, 460V variant: 650 */
//////////////////////////////////////////////////////////
...
#define default_BK_VBUS_ADD             (uint16_t) (0.8 * ( OV_VOLTAGE_THRESHOLD_V - NOMINAL_DC_VOLTAGE))   /* based on the difference between voltage levels and OVP setting */
...
#define OTF_PHASE1_TIMEOUT              3000 //5000
