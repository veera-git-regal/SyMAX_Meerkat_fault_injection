...
#define default_MOTOR_INERTIA           49.1 //29.1 /* just for test on the blender */
#define default_MOTOR_VISCOUS_DAMPING   98.2 //48.2      /* RPa: coefficient of dynamic friction */
#define TORQUE_CONSTANT                 (MOTOR_VOLTAGE_CONSTANT/ 60.459979) /* RPa: Ke/((3/sqrt(3))*(60/2/pi)/1000); Nm/A (rms) */
#define FAN_INERTIA                     200 //50 /*RPa: g*m^2 */
