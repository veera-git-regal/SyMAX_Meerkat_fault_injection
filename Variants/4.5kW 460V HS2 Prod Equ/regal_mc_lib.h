...
#define default_OCP_THRESHOLD           (uint16_t) (0.9 * NOMINAL_CURRENT) /* based on OCP settings */
#define default_OCP_RPM_REDUCE          10
#define default_OCP_DERATE_PERIOD       200
#if HARDWARE_VERSION == HARDWARE_VERSION_1p3KW
#define default_OVP_THRESHOLD           (int16_t) (0.98 * 1400)  /* based on mechanical power and efficiency */
#elif HARDWARE_VERSION == HARDWARE_VERSION_4p5KW
#define default_OVP_THRESHOLD           (int16_t) (0.98 * 4600)  /* based on mechanical power and efficiency */
...
#define default_OTF_DBEMFG              100 //256 //230V: 256 460V 100 /* RPa: Ke (based on observer design  and voltage level under operation; please refer to On-the-fly document for more information */
