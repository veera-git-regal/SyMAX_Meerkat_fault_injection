...
#define default_MOTOR_INERTIA           0.5 //29.1 /* just for test on the blender */
#define default_MOTOR_VISCOUS_DAMPING   25 //48.2      /* RPa: coefficient of dynamic friction */
#define TORQUE_CONSTANT                 (MOTOR_VOLTAGE_CONSTANT/ 60.459979) /* RPa: Ke/((3/sqrt(3))*(60/2/pi)/1000); Nm/A (rms) */
#define FAN_INERTIA                     0.5 //50 /*RPa: g*m^2 */
...
#define default_OTF_DBEMFG              256 /* RPa: Ke  and voltage levels */
...
#define default_WM_CLAMP_CURRENT (uint16_t)(PHASE3_FINAL_CURRENT + (0.25 * (WM_MAX_CLAMP_CURRENT - PHASE3_FINAL_CURRENT)))
#define WM_PH5CURRENT_OL2CL (uint16_t) PHASE5_FINAL_CURRENT
#define default_WM_BK_REVERSE_ENDSPEED  (uint16_t) (default_BK_ENDSPEED) //(default_BK_ENDSPEED/2)
