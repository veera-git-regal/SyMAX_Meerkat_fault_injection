...
#define RS                     0.04 /* Stator resistance , ohm*/
#define LS                     0.001100 /* Stator inductance, H
...
#define NOMINAL_CURRENT         22123
#define MOTOR_MAX_SPEED_RPM     4012 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  54.4 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -22123 /*!< Demagnetization current */
