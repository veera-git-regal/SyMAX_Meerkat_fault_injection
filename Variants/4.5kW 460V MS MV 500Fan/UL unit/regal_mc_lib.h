...
#define default_MOTOR_INERTIA           45 /* just for test on the blender */
#define default_MOTOR_VISCOUS_DAMPING   10 /* RPa: coefficient of dynamic friction */
...
#define default_OTF_DBEMFG             100 //200 /* RPa: Ke (based on observer design  and voltage level under operation; please refer to On-the-fly document for more information */
