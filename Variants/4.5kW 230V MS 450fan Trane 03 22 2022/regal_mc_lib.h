...
#define default_BK_VBUS_CLIP            (uint16_t) (0.7 * ( OV_VOLTAGE_THRESHOLD_V - NOMINAL_DC_VOLTAGE))   /* based on the difference between voltage levels and OVP setting */
#define default_BK_ENDSPEED             25 //(uint16_t) (1110 / MOTOR_VOLTAGE_CONSTANT)   /* RPa: Ke, SNR, and voltage levels, arbitrary: 10V bemf level, but this needs to consider OCP */
