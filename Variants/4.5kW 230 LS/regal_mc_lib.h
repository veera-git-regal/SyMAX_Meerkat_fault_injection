...
#define default_MOTOR_INERTIA           49.1 /* g*m^2 */
...
#define FAN_INERTIA                             243.0 /*RPa: g*m^2 */
...
#define default_OVP_THRESHOLD           4359  /* based on mechanical power, include an efficiency */
