...
#define VBUS_BASED_POWER_LIMIT FALSE // Allow updating power limit based on Vbus. Crated for Trane to limit input amps. 
...
#define HARDWARE_VERSION_1p3KW_MV 6

#define HARDWARE_VERSION HARDWARE_VERSION_1p3KW_MV//HARDWARE_VERSION_1p3KW // set this to choose the HW version

// GPIO Input Ports/Pins
#if ((HARDWARE_VERSION == HARDWARE_VERSION_1p3KW) || (HARDWARE_VERSION == HARDWARE_VERSION_1p3KW_REVE_AND_BELOW) || (HARDWARE_VERSION == HARDWARE_VERSION_1p3KW_MV))
