...
#define PID_TORQUE_KP_DEFAULT         2912
#define PID_TORQUE_KI_DEFAULT         57
#define PID_TORQUE_KD_DEFAULT         100
//#define PID_FLUX_KP_DEFAULT           5400
//#define PID_FLUX_KI_DEFAULT           160
#define PID_FLUX_KP_DEFAULT           3916
#define PID_FLUX_KI_DEFAULT           57
...
#define PHASE1_FINAL_CURRENT           14894
/* Phase 2 */
#define PHASE2_DURATION                0 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (0*SPEED_UNIT/_RPM)
#define PHASE2_FINAL_CURRENT           14894
/* Phase 3 */
#define PHASE3_DURATION                1000 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (0*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           14894
/* Phase 4 */
#define PHASE4_DURATION                5000 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (1800*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           19858
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (1800*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           19858
