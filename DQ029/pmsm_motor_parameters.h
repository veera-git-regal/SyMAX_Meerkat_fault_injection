...
#define RS                     2.62 /* Stator resistance , ohm*/
#define LS                     0.053819 /* Stator inductance, H
...
#define MOTOR_MAX_SPEED_RPM     1750 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  90.0 /*!< Volts RMS ph-ph /kRPM */
