...
SpeednTorqCtrl_Handle_t SpeednTorqCtrlM1 =
{
  ...
  .MaxPositiveTorque =	(int16_t)NOMINAL_CURRENT,		 //pam
  .MinNegativeTorque =	-(int16_t)NOMINAL_CURRENT,       //pam
...
VirtualSpeedSensor_Handle_t VirtualSpeedSensorM1 =
{
  ...
  ._Super = {
    .bElToMecRatio                     =	POLE_PAIR_NUM, //pam
...
void RegalSetting_Init(void){
  ...
  VirtualSpeedSensorM1._Super.bElToMecRatio = POLE_PAIR_NUM;
  
  STO_PLL_M1._Super.bElToMecRatio =  POLE_PAIR_NUM;
  
  HALL_M1._Super.bElToMecRatio =  POLE_PAIR_NUM;
  
  SpeednTorqCtrlM1.MaxPositiveTorque = (int16_t)NOMINAL_CURRENT;		 
  SpeednTorqCtrlM1.MinNegativeTorque =	-(int16_t)NOMINAL_CURRENT;   
  
  STO_PLL_M1.PIRegulator.hDefKpGain = PLL_KP_GAIN;
