...
#define default_FAULT_AUTOSTART         DISABLE /* enable/disable auto-start when fault occurs */
...
#define default_OVP_THRESHOLD           (int16_t) (0.98 * 4500)  /* based on mechanical power and efficiency */
...
#define default_REGAL_OTF               DISABLE /* enable/disable of Regal On-the-fly feature */
#define default_CONTROLLED_BRAKING      DISABLE  /* enable/disable for the Regal Controlled Braking feature*/
#define default_DECEL_CONTROL           DISABLE  /* enable/disable for the Regal Controlled Deceleration feature */
