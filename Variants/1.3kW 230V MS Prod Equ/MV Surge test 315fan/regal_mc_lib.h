...
#define default_STOP_TIMEOUT           (uint32_t)10000 /* in msec, goes back to IDLE when timesout */
...
#define default_OTF_DBEMFG             200 /* RPa: Ke (based on observer design  and voltage level under operation; please refer to On-the-fly document for more information */
