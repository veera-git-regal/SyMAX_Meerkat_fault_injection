...
#define MAX_APPLICATION_SPEED_RPM       2200 /*!< rpm, mechanical */
...
/****** State Observer + PLL ****/
#define VARIANCE_THRESHOLD              1.6 /*!<Maximum accepted 
                                                            variance on speed 
...
#define PLL_KP_GAIN                      878
#define PLL_KI_GAIN                      77
...
#define PID_TORQUE_KI_DEFAULT         38
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           1832
#define PID_FLUX_KI_DEFAULT           38
...
#define PID_SPEED_KP_DEFAULT          12000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          750/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V          850 /*!< Over-voltage
                                                         threshold */
...
#define ON_OVER_VOLTAGE                 TURN_OFF_PWM /*!< TURN_OFF_PWM,
                                                         ...
                                                         TURN_ON_LOW_SIDES */
#endif /* 0 */
#define R_BRAKE_SWITCH_OFF_THRES_V      680
