...
#define RS                     0.32 /* Stator resistance , ohm*/
#define LS                     0.004700 /* Stator inductance, H
...
#define NOMINAL_CURRENT         22999
#define MOTOR_MAX_SPEED_RPM     4200 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  130.0 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -22999 /*!< Demagnetization current */
