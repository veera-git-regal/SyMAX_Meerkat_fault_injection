...
#define PID_BRAKE_KP_DEFAULT 25 //545   // Proportional Gain for Bus Voltage Controller
...
#define BK_KPDIV 32            //Proportional Gain divider for Bus Voltage Controller
...
#define FAN_INERTIA                     200 /*RPa: g*m^2 */
#define TOTAL_INERTIA                   (float) ( default_MOTOR_INERTIA + FAN_INERTIA )
#define NOMINAL_DC_VOLTAGE              NOMINAL_BUS_VOLTAGE_V //330 /*230V variant: 375, 460V variant: 650; nominal dc voltage as seen on the bus */
//////////////////////////////////////////////////////////
...
#define default_MAX_COMMANDABLE_SPEED (uint16_t)(0.98 * MAX_APPLICATION_SPEED_RPM) /* maximum commandable speed is based on the maximum application speed*/
...
#if ((HARDWARE_VERSION == HARDWARE_VERSION_1p3KW) || (HARDWARE_VERSION == HARDWARE_VERSION_1p3KW_REVE_AND_BELOW) || (HARDWARE_VERSION == HARDWARE_VERSION_1p3KW_REVE_AND_BELOW_EXT_CRYSTAL))
#define default_OVP_THRESHOLD (int16_t)(0.98 * 1450) /* based on mechanical power and efficiency */
...
#define default_OTF_DBEMFG           200 //230V: 256 460V: 100 /* RPa: Ke (based on observer design  and voltage level under operation; please refer to On-the-fly document for more information */
...
#define default_WM_BK_REVERSE_ENDSPEED  (uint16_t) (default_BK_ENDSPEED/2) //(default_BK_ENDSPEED/2)
