...
#define RS                     1.60 /* Stator resistance , ohm*/
#define LS                     0.007000 /* Stator inductance, H
...
#define NOMINAL_CURRENT         5476
#define MOTOR_MAX_SPEED_RPM     2000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  90.7 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -5476 /*!< Demagnetization current */
