...
#define RS                     0.17 /* Stator resistance , ohm*/
#define LS                     0.002470 /* Stator inductance, H
...
#define NOMINAL_CURRENT         21938
#define MOTOR_MAX_SPEED_RPM     3500 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  40.3 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -21938 /*!< Demagnetization current */
