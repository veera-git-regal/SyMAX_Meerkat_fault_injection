...
#define RS                     0.66 /* Stator resistance , ohm*/
#define LS                     0.009866 /* Stator inductance, H
...
#define NOMINAL_CURRENT         14556
#define MOTOR_MAX_SPEED_RPM     3500 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  46.2 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -14556 /*!< Demagnetization current */
