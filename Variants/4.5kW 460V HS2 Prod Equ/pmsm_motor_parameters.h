...
#define NOMINAL_CURRENT         20809
#define MOTOR_MAX_SPEED_RPM     4300 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  82.7 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -20809 /*!< Demagnetization current */
